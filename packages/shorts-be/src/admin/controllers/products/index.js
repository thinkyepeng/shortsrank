...
const { LIST_FIELDS } = require('../../models/product');
...
async function updateData(req, res, next) {
  ...
  const {
    id, coins, description, price, product_id, product_name, enabled, sort,
  } = req.body;
  const updateData = {
    coins, description, price, product_id, product_name, enabled, sort,
  };
